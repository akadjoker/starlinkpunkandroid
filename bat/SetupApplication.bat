...
:: Android packaging
set AND_CERT_NAME="starlinkpunkandroid"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\starlinkpunkandroid.p12
...
set IOS_PROVISION=cert\starlinkpunkandroid.mobileprovision
...
set APP_ID=air.starlinkpunkandroid

:: Output packages
set DIST_PATH=dist
set DIST_NAME=starlinkpunkandroid

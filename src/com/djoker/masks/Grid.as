package com.djoker.masks
{
	import com.djoker.SPMask;
	 ...
	 */
	public class Grid extends SPHitbox
	{
		/**
		...
		public function Grid(width:uint, height:uint, tileWidth:uint, tileHeight:uint, x:int = 0, y:int = 0) 
		{
			...
			_data = new BitmapData(_columns + width, _rows + height, true, 0);
			_x = x;
			_y = y;
			_width = width;
			_height = height;
		...
		*/
		...
		/** @private */ private var _point2:Point = SP.point2;
	}
}